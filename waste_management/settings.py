...
# Ensure that the Streamlit server is only started once, not during Django's auto-reload subprocess
# if os.environ.get('RUN_MAIN') == 'true':
#     # Path to your Streamlit app script
#     streamlit_file_path = os.path.join(BASE_DIR, 'app.py')  # Adjust BASE_DIR and app.py path if necessary
